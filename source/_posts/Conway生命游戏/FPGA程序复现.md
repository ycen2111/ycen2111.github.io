...
最终本项目可以允许用户使用Ps2，鼠标左键添加新的cell，右键删去cell，中键拖动画布，并通过VGA显示
FPGA上下键放大，缩小画布，左右键增加，减少画布大小，并通过左边第二个switch选择调整的是x轴或y轴
x/y轴大小数量会在7-segments上显示
推动左边第三个switch可以开始/暂停运行，最左边switch用来reset整个系统
![001.png](001.png)

系统可以在VGA显示下最大1024*512大小画布以60Hz运行，如果不用VGA显示理论可达到3051.76Hz（100MHz CLK）
